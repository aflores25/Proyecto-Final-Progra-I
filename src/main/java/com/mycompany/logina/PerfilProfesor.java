...
public class PerfilProfesor extends javax.swing.JFrame {
    ...
    public PerfilProfesor() {
        ...
        perfil = LoginA.profesorLogeado;
        jTextField1.setText(perfil.nombre);
        jTextField2.setText(perfil.apellido);
        jTextField3.setText(perfil.usuario);
        jTextField4.setText(perfil.password);
        jTextField5.setText(perfil.especialidad);
    }
    ...
    private void initComponents() {
        ...
        jLabel5.setText("PERFIL PROFESOR");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if(Password.verificacion(jTextField4.getText())){
            perfil.password = jTextField4.getText();
